-- ============================================================
-- Society Management System - Standalone Schema Script
-- Run this manually against MySQL if you are not letting Flyway
-- (backend/src/main/resources/db/migration/V1__init.sql) manage the schema.
-- Usage:
